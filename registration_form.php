...
<div id="container_2">
    <form id="survey-form" action="form-submit.php" method="post">
        ...
        <input type="text" id="sponsers-name" name="sponsers-name" class="form" required
               placeholder="Enter Sponsor's name"><br><!--name--->
        <label id="sponsers-email-label"> Sponsor's Email: </label>
        <input type="email" id="sponsers-email" name="sponsers-email" class="form" required
               placeholder="Enter Sponsor's email"><br><!---email-->
        <label id="sponsors-number-label">Sponsor's Number: </label>
        <input type="tel" id="sponsers-phone" name="sponsers-phone" placeholder="123-456-7899"
        ...
        <input type="text" id="spouses-name" name="spouses-name" class="form" required
               placeholder="Enter Spouse's name"><br>
        <label id="spouses-email-label"> Spouse's Email: </label>
        <input type="email" id="spouses-email" name="spouses-email" class="form" required
               placeholder="Enter Spouse's email"><br>
        <label id="spouses-number-label">Spouse's Number: </label>
        <input type="tel" id="spouses-phone" name="spouses-phone" placeholder="123-456-7899"
               pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
...
<div id="right">
    ...
    <input type="email" id="students-email" name="students-email" class="form" required
           placeholder="Enter Student's email"><br>
    <label id="students-number-label">Student's Number: </label>
    <input type="tel" id="students-phone" name="students-phone" placeholder="123-456-7899"
           pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required>
    <br>
    <br>
